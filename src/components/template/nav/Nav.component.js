...
import movieSvg from "./../../../assets/images/movie-svg.svg";
class Nav extends Component {
  render() {
    return <div>
      <div className="bg-slate-800 border-gray-200 px-2 sm:px-4 py-3.5 dark:bg-gray-800">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="#" className="flex">
            <img className="mr-3 h-10" src={movieSvg}></img>
            <span className="text-white self-center text-lg font-semibold whitespace-nowrap dark:text-white">Movie app</span>
          </a>
